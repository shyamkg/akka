...
case class DispatcherFromConfig(path: String) extends DispatcherSelector
case class DispatcherFromExecutor(executor: Executor) extends DispatcherSelector
case class DispatcherFromExecutionContext(ec: ExecutionContext) extends DispatcherSelector
